...
stopuser = {}
token = "7431657399:AAHYSB8CDltevXXG7vddrxuQu27ypLLVHWU"
...
ϟ Programmer ~ @Xclpk</b>''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
...
ϟ - Programmer • @Xclpkϟ</strong>''',reply_markup=keyboard)
...
- Programmer ~ @Xclpk - @P_3_Y1 </b>''',reply_markup=keyboard)
			return
		with open('data.json', 'r') as file:
			json_data = json.load(file)
...
def respondn_to_vhk(message):
 bot.reply_to(message,'''• اسعار اشترالبوBot Prices •
